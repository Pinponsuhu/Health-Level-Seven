        ...
        <div class="mt-3 px-8">
            <div class="bg-white rounded-md shadow-md p-6">
                <div class="flex justify-between">
                    <h1 class="text-green-500 items-center font-bold text-xl mb-4">All Active Request</h1>
                    <div class="flex items-center gap-x-2">
                        <a href="/department/new/request" class="py-2 rounded-md px-4 bg-green-400 text-white">Add new</a>
                        <a href="#" class="py-2 rounded-md px-6 bg-red-400 text-white">Closed Request</a>
                    </div>
                </div>
                <div class="mt-4">
                    @if ($reqs->count() != null)
