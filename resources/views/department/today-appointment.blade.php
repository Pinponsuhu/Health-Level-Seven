            ...
            <div class="p-3 md:p-6 rounded-md shadow-md bg-white">
                <div class="flex justify-between items-center">
                    ...
                    <div class="md:flex hidden items-center gap-x-3">
                        <a href="/department/today/appointments/{{ Crypt::encrypt('Cancelled') }}" class="py-2 px-4 rounded-md text-white bg-yellow-400">Cancelled</a>
                        <a href="/department/today/appointments/{{ Crypt::encrypt('Active') }}" class="py-2 px-4 rounded-md text-white bg-green-400">Active</a>
                        <a href="/department/today/appointments/{{ Crypt::encrypt('Missed') }}" class="py-2 px-4 rounded-md text-white bg-red-400">Missed</a>
                    </div>
                </div>
