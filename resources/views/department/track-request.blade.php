        ...
        <div class="mt-3 px-8 h-full">
            <div class="bg-white rounded-md shadow-md p-6 h-full overflow-y-scroll">
                <div class="w-11/12 mx-auto">
                    ...
                    <div class="mt-3 flex gap-x-4 mb-2 border-b-2 border-gray-200 pb-3 items-center">
                    ...
                    @if ($replies->count() == 0 && $req->status == 'Open')
                    <a href="/department/reply/request/{{ Crypt::encrypt($req->id) }}" class="bg-blue-500 block mt-3 w-28 text-center py-2 text-white">Reply</a>
                    @endif
                </div>
