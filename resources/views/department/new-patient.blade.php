...
<main class="w-full overflow-y-scroll h-screen">
    ...
    <form action="/department/new/patient" class="w-8/12 mb-6 grid grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md shadow-md mt-8 bg-white" method="post" enctype="multipart/form-data">
        @csrf
