    ...
    <main class="w-full">
        ...
        <div>
            ...
            <form action="/department/confirm/patient" method="get" class="w-8/12 mx-auto mt-2 flex gap-x-3">
                @csrf
                <input type="text" class="shadow-md rounded-md flex w-9/12 bg-white py-2 px-3" name="search" placeholder="Search By Patient ID or Surname" id="">
                            ...
                            <tbody>
                                @foreach ($patients as $patient)
                                    <tr>
                                        ...
                                        <td class="px-3"><a href="/department/use/existing/{{ $patient->id }}" class="px-5 py-2 bg-blue-500 text-white rounded-md">Use</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
