        ...
        <div class="px-4 md:px-8 mt-3">
            <div class="p-3 md:p-6 rounded-md shadow-md bg-white">
                <div class="flex justify-between items-center">
                    <h1 class="font-bold text-xl md:text-2xl text-green-600 my-5">Prebooked Appointments</h1>
                    <div class="md:flex hidden items-center gap-x-3">
                        <a href="/department/prebooked/appointment/{{ Crypt::encrypt('Cancelled') }}" class="py-2 px-4 rounded-md text-white bg-yellow-400">Cancelled</a>
                        <a href="/department/prebooked/appointment/{{ Crypt::encrypt('Active') }}" class="py-2 px-4 rounded-md text-white bg-green-400">Active</a>
                        <a href="/department/prebooked/appointment/{{ Crypt::encrypt('Missed') }}" class="py-2 px-4 rounded-md text-white bg-red-400">Missed</a>
                    </div>
                </div>
