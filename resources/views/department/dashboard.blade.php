...
@section('content')
        <main class="w-full h-screen overflow-y-scroll">
            ...
            <div class="mb-5 ">
            <div class="h-72 md:h-96 md:grid gap-y-4  mt-3 px-4">
            ...
            <div class="md:grid md:grid-cols-4 h-56 mt-10 md:mt-12 px-4 gap-x-4">
                <section class="bg-white rounded-md shadow-md md:col-span-3 py-3 px-4">
                    <div class="flex items-center py-3 justify-between px-8 mb-4">
                        ...
                        <a href="/department/today/appointments/{{ Crypt::encrypt('Active') }}" class="text-lg font-medium text-green-500">See all</a>
                    </div>
                ...
                <a href="/department/covid/tracker">
                    <section class="md:grid bg-gradient-to-br px-6 mt-4 md:mt-0 py-12 from-green-500 to-green-400 rounded-md shadow-md">
