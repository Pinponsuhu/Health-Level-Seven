        ...
        <div class="mt-3 px-8">
            <div class="bg-white p-6 rounded-md shadow-md w-full">
                <section class="mt-4 px-4">
                    <a href="/department/bed/management" class="block w-28 text-lg text-center ml-6 rounded-full py-2 shadow-md bg-green-500 text-white"><i class="fa fa-arrow-left text-sm mr-1"></i> Back</a>
