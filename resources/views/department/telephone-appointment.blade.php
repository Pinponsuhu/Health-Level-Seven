...
@section('content')
    <main class="w-full">
        ...
        <div class="px-4 md:px-8 mt-3">
           <div class="bg-white p-3 md:p-6 rounded-md w-full shadow-md">
            <div class="flex justify-between items-center">
                <h1 class="font-bold text-xl md:text-2xl text-green-600 my-5">Telephone Consultancy Appointments</h1>
