        ...
        <div class="mt-3 px-8">
            <div class="p-6 bg-white rounded-md shadow-md">
                ...
                <form action="/department/new/request" mt-3 class="w-7/12" enctype="multipart/form-data" method="post">
                    ...
                    <textarea name="content" placeholder="Request Description" class="outline-none shadow-md w-full block resize-none py-3 px-3 border-l-4 rounded-md border-green-400" id="" cols="30" rows="4">{{ old('content') }}</textarea>
