    ...
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <div class="mt-4 px-8">
            <div class="p-6 bg-white rounded-md shadow-md">
                <h1 class="text-2xl font-bold text-center text-green-500">Search result for: "{{ $search }}"</h1>
                <form action="/department/search/items" class="md:w-8/12 mx-auto grid capitalize grid-cols-4 gap-x-3 items-center my-3" method="get">
                    @csrf
