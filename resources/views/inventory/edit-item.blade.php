...
@section('content')
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <form action="/store/edit/item/{{ Crypt::encrypt($item->id) }}" class=" w-8/12 mb-6 grid grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md shadow-md mt-8 bg-white" method="post" enctype="multipart/form-data">
            @csrf
