        ...
        <div class="mt-4 px-8">
            <div class="w-full bg-white shadow-md rounded-md p-6">
                <div class="flex justify-end gap-x-5">
                    <a href="/edit/item/{{ $item->id }}" class="text-white bg-blue-500 rounded-md px-6 py-3">Edit</a>
                    <a href="/assign/item/{{ $item->id }}" class="text-white bg-green-500 rounded-md px-6 py-3">Assign</a>
                    <a href="/delete/item/{{ $item->id }}" class="text-white bg-red-500 rounded-md px-6 py-3">Delete</a>
                </div>
