    ...
    <main class="w-11/12 mx-auto h-screen py-4">
        ...
        <form action="/super/admin/new/hospital" class="w-10/12 md:w-8/12 mb-6 grid md:grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md shadow-md mt-8 bg-white h-full overflow-y-scroll" method="post" enctype="multipart/form-data">
            ...
            <div class="my-2">
                ...
                <input type="file" value="{{ old('hospital_logo') }}" name="hospital_logo" class="capitalize border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
                @error('hospital_logo')
            ...
            <div class="my-2">
                ...
                <input type="text" value="{{ old('hospital_name') }}" name="hospital_name" placeholder="Enter Hospital Name" class="capitalize border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
                @error('hospital_name')
                    <p class="text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            <div class="my-2">
                ...
                <input type="text" value="{{ old('head_of_hospital') }}" name="head_of_hospital" placeholder="Enter Hospital " class="capitalize border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
            ...
            <div class="my-2">
                ...
                <input type="text" value="{{ old('phone_number') }}" name="phone_number" placeholder="Enter Hospital Number" class="capitalize border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
                @error('phone_number')
                    <p class="text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            <div class="my-2">
                ...
                <input type="text" value="{{ old('hospital_address') }}" name="hospital_address" placeholder="Enter Hospital Address" class="capitalize border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
            ...
            <div class="my-2">
                ...
                <input type="text" value="{{ old('password') }}" name="password" placeholder="Enter Hospital Password" class="border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
                @error('password')
                    <p class="text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            <div class="my-2">
                ...
                <input type="text" value="{{ old('confirm_password') }}" name="password_confirmation" placeholder="Confirm Hospital Password" class="border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
