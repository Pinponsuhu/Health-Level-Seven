...
@section('content')
    <main class="w-full flex h-screen">
        <nav id="hospital" class="w-72 md:w-96 bg-green-400 fixed left-0 top-0 md:relative h-full hidden md:block  overflow-y-scroll md:p-4">
    ...
    <div onclick="all_hospital()" id="nav" class="fixed top-20 right-2 p-4 rounded-md block md:hidden bg-white text-green-500">
