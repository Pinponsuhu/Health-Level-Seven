...
@section('content')
    <main class="w-full overflow-y-scroll h-screen pb-6">
        ...
        <div class="h-screen">
            <form action="/existing/store/{{ Crypt::encrypt($patient->id) }}" class="w-11/12 md:w-8/12 mb-6 grid md:grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md items-center shadow-md mt-3 md:mt-8 bg-white" method="post" enctype="multipart/form-data">
                @csrf
