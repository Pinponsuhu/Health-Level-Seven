            ...
            <div class="p-6 rounded-md shadow-md bg-white">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-x-3">
                        <a href="/prebooked/appointment/{{ Crypt::encrypt('Cancelled') }}" class="py-2 px-4 rounded-md text-white bg-yellow-400">Cancelled</a>
                        <a href="/prebooked/appointment/{{ Crypt::encrypt('Active') }}" class="py-2 px-4 rounded-md text-white bg-green-400">Active</a>
                        <a href="/prebooked/appointment/{{ Crypt::encrypt('Missed') }}" class="py-2 px-4 rounded-md text-white bg-red-400">Missed</a>
                    </div>
                </div>
