...
@section('content')
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <form action="/upload/radiology" class="w-11/12 md:w-8/12 mb-6 grid md:grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md shadow-md mt-8 bg-white" method="post" enctype="multipart/form-data">
            @csrf
            <h1 class="md:col-span-2 text-2xl font-semibold text-green-600 mb-3">Result Tracker</h1>
            <div class="my-2">
