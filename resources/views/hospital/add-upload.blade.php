    ...
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <form action="/upload/radiology" class=" w-8/12 mb-6 grid grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md shadow-md mt-8 bg-white" method="post" enctype="multipart/form-data">
            ...
            <div class="my-2">
                ...
                <input type="text" value="{{ old('full_name') }}" name="full_name" placeholder="Enter Patient's Surname" class="capitalize border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block">
                @error('full_name')
