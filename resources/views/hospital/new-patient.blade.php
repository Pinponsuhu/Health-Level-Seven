    ...
    <form action="{{ route('store_patient') }}" class="w-8/12 mb-6 grid grid-cols-2 mx-auto gap-x-5 px-8 py-5 rounded-md shadow-md mt-8 bg-white" method="post" enctype="multipart/form-data">
       ...
       <div class="col-span-2 my-2 grid grid-cols-2 gap-x-3">
        ...
        <div class="my-2">
            ...
            <input type="text" value="{{ old('next_of_kin') }}" name="next_of_kin" class="border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block"  placeholder="Enter Patient's Occupation">
        ...
        <div class="my-2">
            ...
            <input type="text" value="{{ old('next_of_kin_number1') }}" name="next_of_kin_number1" class="border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block"  placeholder="Enter Patient's Occupation">
        ...
        <div class="my-2">
            ...
            <input type="text" value="{{ old('next_of_kin_number1') }}" name="next_of_kin_number2" class="border-l-4 border-green-500 w-full rounded-md p-3 shadow-md outline-none block"  placeholder="Enter Patient's Occupation">
