...
@section('content')
    <main class="w-full">
        ...
        <div class="px-4 md:px-8 mt-3">
            <div class="w-full bg-white rounded-md shadow-md p-3 md:p-6">
                <h1 class="text-xl font-bold  text-green-500 my-4">All Archieve Patient</h1>
                ...
                <tbody>
                    @foreach ($patients as $patient)
                        <tr>
                            ...
                            <td class="px-3"><a href="/restore/patient/details/{{ Crypt::encrypt($patient->id) }}" class="px-5 py-2 bg-blue-500 text-white rounded-md">Restore</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
