    ...
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <div class="mt-6 px-8">
            <div class="rounded-md shadow-md bg-white p-6">
                ...
                <div class="grid md:grid-cols-4 gap-x-4 items-center mt-6">
                    ...
                    <a href="/all/staffs">
                    <div class="bg-red-200 h-32 mt-3 md:mt-0 flex justify-between shadow-md gap-x-2 rounded-md py-4 px-5">
                        <div>
