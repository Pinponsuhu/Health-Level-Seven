    ...
    <main class="w-full h-screen">
        ...
        <div class="mt-3 px-8">
            <div class="p-6 bg-white rounded-md shadow-md">
                ...
                <form action="/hospital/new/complaint" class="w-11/12 md:w-7/12 mt-3" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <label class="block font-bold mb-1 mt-2 text-md text-green-800">Description *</label>
                    <textarea name="content" placeholder="Complain Description" class="outline-none shadow-md w-full block resize-none py-3 px-3 border-l-4 rounded-md border-green-400" id="" cols="30" rows="4">{{ old('content') }}</textarea>
